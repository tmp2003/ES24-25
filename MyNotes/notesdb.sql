...
(23, 7, 23, 6, 'Nota com média 4.1', 'Conteúdo da nota 4.1', 0, '2025-05-29 10:00:00', '2025-05-29 10:00:00'),
(24, 7, 24, 6, 'Nota com média 5', 'Conteúdo da nota 5', 0, '2025-05-29 10:05:00', '2025-05-29 10:05:00'),
(25, 7, 23, 6, 'Nota com média 3', 'Conteúdo da nota 3', 0, '2025-05-29 10:10:00', '2025-05-29 10:10:00'),
(26, 7, 24, 6, 'Nota com média 4.5', 'Conteúdo da nota 4.5', 0, '2025-05-29 10:15:00', '2025-05-29 10:15:00');
...
CREATE TABLE `note_ratings` (
  ...
  KEY `fk_note_ratings_note` (`note_id`),
  KEY `fk_note_ratings_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;


--
-- Extraindo dados da tabela `note_ratings`
--
...
-- Restrições para a tabela `note_ratings`
ALTER TABLE `note_ratings`
  ADD CONSTRAINT `fk_note_ratings_note` FOREIGN KEY (`note_id`) REFERENCES `notes` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_note_ratings_user` FOREIGN KEY (`user_id`) REFERENCES `userdata` (`id`) ON DELETE CASCADE;
